...
class SelectListingTypeViewController: UIViewController {
    ...
    let ShortTermParking = ShortTermParkingSpot.init(id: "", address: Address.blankAddress(), coordinates: Coordinate(lat: 0.0, long: 0.0), pricePerHour: 0.0, pricePerDay: 0.0, dailyPriceEnabled: false, provider: "", comments: "", tags: [String](),reservations: [String](), fromFullDays: [Int](), images: [String](), startDate: 0, endDate: 0, directions: "", selfParking: SelfParking.blank(), approvedReservations: [])
