...
class SelectListingTypeViewController: UIViewController {
    ...
    let ShortTermParking = ShortTermParkingSpot.init(id: "", address: Address(city: "", state: "", street: "", zip: ""), coordinates: Coordinate(lat: 0.0, long: 0.0), pricePerHour: 0.0, provider: "", comments: "", tags: [String](), firstName: "First", lastName: "Last", reservations: [String](), fromFullDays: [Int](), images: [String](), directions: "")
